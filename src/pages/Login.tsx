...
const loginVideo = "https://ldaezqygnybifycfuiyd.supabase.co/storage/v1/object/public/assets/12511042_3840_2160_60fps.mp4";
...
const styles: Record<string, React.CSSProperties> = {
 ...
 overlay: {
    position: "absolute",
    inset: 0,
    background: "linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.4) 50%, rgba(0,0,0,0.65) 100%)",
    zIndex: 1,
},
  noise: {
    position: "absolute",
